...
<head>
	<title>Detail Barang Supplier</title>
...
<body>
	...
	$query1 = mysqli_query($conn, "SELECT * FROM supplier WHERE id_supplier = '$id_supplier'");
	$lihat1 = mysqli_fetch_Assoc($query1);

	?>

	<h4>Detail Barang Supplier</h4>
	<hr>
	...
	<table class="table table-striped table-bordered table-dark">
		...
		<tbody>
			<?php
			$no = 1;
			$query = mysqli_query($conn, "SELECT * FROM barang JOIN golongan_produk ON barang.id_golongan_produk = golongan_produk.id_golongan_produk WHERE id_supplier = '$id_supplier'");
	...
	<a href="m_supplier.php" class="btn btn-danger">Kembali</a>
