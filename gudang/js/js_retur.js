...
function simpanSemuaData() {
  ...
  document.getElementById("err_tgl").innerHTML = "";
  document.getElementById("err_keterangan").innerHTML = "";
  ...
  if (tgl == "") {
    ...
    document.getElementById("err_keterangan").innerHTML = "Wajib diisi..!!";
  } else if (sales == "-") {
  ...
  // jika tidak ada item barang
    ...
    $.ajax({
      type: "POST",
      url: "config/simpan_retur.php",
      data: data2,
      success: function () {
        location = "tampil_retur.php";
      },
    });
    // console.log(data2)
  }
